/* =========================================================
   Archivo: debug_conexion.php
   Descripción:
   Este archivo realiza pruebas de conexión con MySQL
   utilizando diferentes contraseñas y configuraciones.
   Su objetivo es verificar que la conexión PDO funcione
   correctamente.
========================================================= */
<?php
$host = "127.0.0.1";
